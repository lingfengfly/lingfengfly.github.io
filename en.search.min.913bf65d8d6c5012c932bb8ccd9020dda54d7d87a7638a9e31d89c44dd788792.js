...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.231b7aa2437d0d1aca41bf15d08d61914530fc78100af6d5b60afd3fa566a0a5.js',function(){input.required=false;search();});}
