...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.61b12c19f0ae1cea80d3989ccea2794aafb855ac73ddcd7e0ecb513cdb0398bc.js',function(){input.required=false;search();});}
